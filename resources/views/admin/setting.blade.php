...
<body>
    ...
    <div :class="{ 'ml-56': sidebarOpen, 'ml-0': !sidebarOpen }"
        ...
        <div class="flex gap-[10px] items-center mb-[46px]">
            <a href="/" class="font-vietnam font-medium text-base text-[#272727]/50">Pengaturan</a>
            ...
            <h1 class="font-vietnam font-semibold text-base text-black">Offline Store</h1>
        </div>
        <div class=" bg-white rounded-xl py-[27px] px-20 ">
            ...
            <div class="flex gap-5 justify-end">
                <button data-modal-toggle="show-password2" class="text-xs font-vietnam text-[#861B43]">Lihat
                    Password</button>
            ...
            <div class="flex justify-end my-5">
                <button data-modal-toggle="add-product-success"
                    class="px-[13px] py-[10px] rounded-md button text-sm text-white">Tambah</button>
            </div>
                ...
                <thead>
                    <tr class="bg-[#E8FBE8]">
                        <th class="flex items-center px-4 py-2 text-start gap-2">
                            ...
                            <h1 class="text-xs font-vietnam font-semibold">Reseller</h1>
                        </th>
                        <th class="px-4 py-2">
                            <h1 class="text-xs font-vietnam font-semibold text-start">Kota</h1>
                        </th>
                        <th class="px-4 py-2">
                            <h1 class="text-xs font-vietnam font-semibold text-start">No. Hp</h1>
                        </th>
                        <th class="px-4 py-2">
                ...
                <tbody>
                    <tr>
                        <td class="flex items-center mt-1 px-4 py-2 text-start gap-2">
                            ...
                            <h1 class="text-xs font-vietnam font-medium">Clarisa Febry</h1>
                        </td>
                        <td class=" px-4 py-2">
                            <h1 class="text-xs font-vietnam font-medium">Purwokerto</h1>
                        </td>
                        <td class=" px-4 py-2">
                            <h1 class="text-xs font-vietnam font-medium">081233547679</h1>
                        </td>
                        <td class=" px-4 py-2">
                            <div class="flex gap-2">
                                ...
                                <button class="bg-[#E8FBE8] px-2 py-2 rounded-lg hover:bg-[#BA2B60]/20">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <clipPath id="clip0_187_645">
                                                <rect width="16.962" height="16.962" fill="white"
                                                    transform="translate(0.46875 0.784668)" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </button>
