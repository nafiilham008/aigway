<div class="relative">
    <div class="relative lg:block hidden">
        <img src='../assets/images/bg-about2.svg' class=" w-full" />
            ...
            <div class="grid grid-cols-3">
                <div class="col-span-2 flex justify-center px-[151px]">
                    <div class="">
                        ...
                        <h1 class="text-lg font-inter text-[#272727]">Kami membuat perawatan kulit ini
                            untuk anda
                            dengan cinta. Produk kami menggunakan bahan alami & teknologi modern</h1>
                    </div>
                </div>
                <div class="col-span-1">
                    <img src='../assets/images/ilustras5.svg' class=" w-full" />
                </div>
            </div>
            </h1>
        </div>
    ...
    <div class="relative block lg:hidden">
        <img src='../assets/images/bg-about2.png' class=" w-full md:h-auto h-[226px]" />
        <div class="absolute top-1 flex items-center h-full">
            <div class="md:grid md:grid-cols-3">
                <div class="md:col-span-2 flex justify-center  px-8 lg:px-[151px]">
                    <div class="">
                        <h1 class="lg:text-[48px] text-[40px] font-inter font-semibold text-[#272727]">Aigway Skincare
                        </h1>
                        <h1 class="lg:text-lg text-sm font-inter text-[#272727]">Kami membuat perawatan kulit ini
                            untuk anda
                            dengan cinta. Produk kami menggunakan bahan alami & teknologi modern</h1>
                    </div>
                </div>
    ...
    <div class="bg-[#F6E0E6]/50 mb-20 lg:mb-[138px]">
        <div class="lg:grid lg:grid-cols-12 py-9 px-8 lg:px-28">
            <div class="lg:col-span-6 flex lg:justify-start justify-center items-center mb-10 lg:mb-0">
                <img src="../assets/images/ilustrasi4.svg" class="md:w-[504] h-auto" alt="">
            </div>
            <div class="lg:col-span-6">
                <h1
                    class="lg:text-[45px] text-[35px] font-inter font-semibold text-[#272727] mb-4 lg:mb-[38px] text-start lg:text-center">
                    Tentang
                    Kami</h1>
                <h1 class="lg:text-lg text-sm font-vietnam text-[#272727] font-normal text-justify lg:text-start">Aigway
                    memulai perjalanan bisnis
                    Skincare pada
    ...
    <div class="relative">
        <div class="lg:px-28 px-8">
            <h1 class="lg:text-[45px] text-[30px] text-[#272727] font-inter font-semibold mb-5">Mau Jadi Reseller?</h1>
            <h1 class="lg:text-lg text-sm font-vietnam md:w-3/5">Ayo gabung bersama kami dan dapatkan keuntungan dari
                penjualan
        ...
        <div class="md:grid md:grid-cols-12 lg:mt-[108px] mt-10">
            <div class="md:col-span-4 bg-[#861B43] lg:px-28 px-10 py-5 lg:py-12">
                <ul class="list-disc">
                    <li class="text-white text-xs lg:text-base font-poppins ">Pembelian awal cukup dengan 3 paket Aigway
                        skincare,
            ...
            <div class="md:col-span-4 bg-[#9E3254] lg:px-28 px-10 py-5 lg:py-12">
                <ul class="list-disc">
                    <li class="text-white text-xs lg:text-base font-poppins">Customer yang order di kami akan di arahkan
                        ke
            ...
            <div class="md:col-span-4 bg-[#E35C8D] lg:px-28 px-10 py-5 lg:py-12">
                ...
                <ul class="list-disc">
                    <li class="text-white text-xs lg:text-base font-poppins">Untuk informasi lebih lanjut bisa
                        menghubungi
                        no
    ...
    <div class="flex justify-center  lg:mb-[91px] mt-11">
        <div class="relative mt-3 w-max ">
            <a href="#hubungi-kami" class="w-max">
                <div class="rounded-full bg-[#60D669] py-2.5 px-[71px] w-max">
                    <div class="text-center text-lg font-vietnam text-[#272727] font-semibold">Hubungi kami</div>
                </div>
    ...
    <h1 id="hubungi-kami"
        class="lg:text-[45px] text-[30px] font-inter font-semibold text-[#272727] md:mb-[38px] md:mt-0 mt-[57px] mb-4  text-start lg:px-0 px-8 lg:text-center">
        Temukan Kami</h1>
    <div class="flex md:flex-row flex-col-reverse justify-center gap-[74px] md:mb-24 md:px-8 lg:px-0 px-5">
        <div class="relative" style="z-index: 10;">
            <div wire:ignore id="map" class="lg:h-[372px] lg:w-[496px] md:w-[288px] md:h-[216px]"></div>
        </div>
        <div class="lg:h-[372px] h-96 px-8 md:px-5 overflow-y-auto scrollbar">
            <h1 class="md:text-[28px] font-vietnam text-black text-[22px] font-semibold mb-4">Offline Store Aigway</h1>
            <ul class="list-disc md:text-xl text-lg font-vietnam text-black font-semibold mb-7">
                <li class="list-item">{{ isset($dataUser->city) ? $dataUser->city : 'Kota belum tersedia' }}
                    ({{ isset($dataUser->name) ? $dataUser->name : 'Kota belum tersedia' }})</li>
            </ul>
            ...
            <div class="flex gap-7 mb-[22px]">
                ...
                <h1 class="md:text-lg font-vietnam text-black font-normal text-base">
                    {{ isset($dataUser->address) ? $dataUser->address : 'Alamat belum tersedia' }}</h1>
            </div>
            <div class="flex gap-7 mb-[22px] mg:px-0">
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <a href="mailto:{{ $dataUser->email ?? '' }}"
                    class="md:text-lg font-vietnam text-black font-normal text-base underline underline-offset-2">{{ isset($dataUser->email) ? $dataUser->email : 'Alamat email belum tersedia' }}
                </a>
            </div>
            <div class="flex gap-7 mb-[22px]">
                ...
                <a href="https://wa.me/{{ $dataUser->phone ?? '' }}"
                    class="md:text-lg font-vietnam text-black font-normal text-base ">{{ isset($dataUser->phone) ? $dataUser->phone : 'Nomor telepon belum tersedia' }}
                </a>
            </div>
            <h1 class="md:text-[28px] text-[22px] font-vietnam text-black font-semibold mb-4">Reseller Aigway</h1>
            @foreach ($reseller as $item)
                <ul class="list-disc md:text-xl text-lg font-vietnam text-black font-semibold mb-7">
                    <li class="list-item">{{ isset($item->city) ? $item->city : 'Kota belum tersedia' }}
                        ({{ isset($item->name) ? $item->name : 'Kota belum tersedia' }})
                    </li>
                </ul>
                <div class="flex gap-7 mb-[22px]">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                    ...
                    <h1 class="md:text-lg font-vietnam text-black font-normal text-base">
                        {{ isset($item->address) ? $item->address : 'Alamat belum tersedia' }}</h1>
                </div>
                <div class="flex gap-7 mb-[22px]">
                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="mailto:{{ $item->email ?? '' }}"
                        class="md:text-lg font-vietnam text-black font-normal text-base underline underline-offset-2">{{ isset($item->email) ? $item->email : 'Alamat email belum tersedia' }}
                    </a>
                </div>
                <div class="flex gap-7 mb-[22px]">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                    ...
                    <a href="https://wa.me/{{ $item->phone ?? '' }}"
                        class="md:text-lg font-vietnam text-black font-normal text-base ">{{ isset($item->phone) ? $item->phone : 'Nomor telepon belum tersedia' }}
                    </a>
                </div>
            @endforeach
        </div>
    ...
    <div class="bg-no-repeat bg-center bg-cover md:h-[437px] h-[306px] md:mt-0 mt-20 items-center flex lg:w-full "
        style="background-image: url('../assets/images/banner.svg');">
        <div class="">
            <div class="lg:px-28 px-5">
                <h1 class="md:text-[45px] text-[30px] font-inter font-semibold text-[#272727] mb-[10px] md:mb-5">
                    Testimoni</h1>
                <h1 class="md:text-base text-xs font-vietnam text-[#272727] font-normal mb-4 md:mb-6 w-3/5">Banyak
                    orang telah
                    menggunakan produk kami untuk perawatan kulit mereka dan lihat apa kata mereka.</h1>
                <a href="{{ route('index.testimony') }}"
    ...
    @push('js')
        ...
        <script>
            document.addEventListener('livewire:load', function() {
                var selectedLatitude = {{ $selectedLatitude ?? (count($latitude) > 0 ? $latitude[0] : 0) }};
                var selectedLongitude = {{ $selectedLongitude ?? (count($longitude) > 0 ? $longitude[0] : 0) }};

                var map = L.map('map').setView([selectedLatitude, selectedLongitude], 7);
                ...
                @foreach ($latitude as $key => $lat)
                    ...
                    var popupContent = "Ini adalah lokasi";
                    @if (isset($reseller[$key]) && $reseller[$key]->name)
                        popupContent += " '{{ $reseller[$key]->name }}'";
                    @elseif (isset($dataUser->name))
                        popupContent += " Toko Utama";
                    @endif
