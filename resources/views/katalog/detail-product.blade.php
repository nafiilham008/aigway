...
<body>
    ...
    <div class="flex gap-[10px] items-center px-20 pt-8">
    ...
    <hr class="my-5 h-[0.1px] border-[#D1D1D1] border">
    <div class="grid grid-cols-12 px-20">
        <div class="col-span-6">
            <div class="column">
                <img id=featured src="../assets/images/product 1.png" class="mb-6">

                <div id="slide-wrapper">
                    <button id="slideLeft" class="">
                    ...
                    <div id="slider">
                        <img class="thumbnail active" src="../assets/images/product 1.png">
                        <img class="thumbnail" src="../assets/images/product 2.png">
                        <img class="thumbnail" src="../assets/images/product 3.png">
                        <img class="thumbnail" src="../assets/images/widget-kategori.svg">
                        <img class="thumbnail" src="../assets/images/widget-product.svg">
                        <img class="thumbnail" src="../assets/images/widget-testimoni.svg">
                    </div>
        ...
        <div class="col-span-6">
            <h1 class="text-[40px] font-semibold font-vietnam mb-2">Dark Spot Brightening</h1>
            <h1 class="text-base text-[#272727]/80 font-vietnam mb-[30px]">Serum</h1>
            <h1 class="text-[32px] font-semibold font-vietnam mb-2">IDR 50.000</h1>
            <div class="accordion flex flex-col items-center justify-center">
                ...
                <div class="w-full">
                    ...
                    <div class="accordion__content overflow-hidden bg-grey-lighter">
                        <p class="text-base font-vietnam text-[#272727] p-4">Serum dengan Niacinamide,Tranexamic
                            Acid dan Licorice Extract, yg efektif untuk mencerahkan kulit kusam, menyamarkan bekas
                            jerawat dan noda hitam. Kulit wajah terasa lembap dan cerah bercahaya</p>
                    </div>
                </div>
                <!-- Panel 2 -->
                <div class="w-full">
                    ...
                    <div class="accordion__content overflow-hidden bg-grey-lighter w-full">
                        <div class="p-4 w-full">
                            <div class="flex gap-5 mb-[15px]">
                                ...
                                <h1 class="text-base font-vietnam text-[#272727]">Mencerahkan kulit kusam</h1>
                            </div>
                            <div class="flex gap-5 mb-[15px]">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h1 class="text-base font-vietnam text-[#272727]">Menyamarkan bekas jerawat dan
                                    noda hitam</h1>
                            </div>
                            <div class="flex gap-5 mb-[15px]">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                ...
                                <h1 class="text-base font-vietnam text-[#272727]">Melembabkan dan mencerahkan kulit
                                    wajah</h1>
                            </div>
                        </div>
                    </div>
