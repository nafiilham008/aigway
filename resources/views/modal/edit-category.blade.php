<div>
    <div id="edit-category" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-xl h-full md:h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow">
                <div class="flex justify-between items-center px-10 py-7">
                    <h1 class="text-black text-base font-medium font-vietnam mb-[5px] text-start">Ubah Kategori</h1>
                    <button data-modal-toggle="edit-category">
                ...
                <div
                    ...
                    <div class="flex gap-5 justify-end mt-5">
                        <button class="px-8 py-2 rounded-md button text-sm text-white">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
