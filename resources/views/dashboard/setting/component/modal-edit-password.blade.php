        ...
        <div class="relative bg-white rounded-lg w-[500px] shadow">
            ...
            <div class="bg-white rounded-lg shadow w-full text-center flex flex-col justify-center px-10 pb-7 h-max">
                ...
                <div class="relative mb-3">
                    ...
                    @enderror
                    <div class="flex absolute top-3 right-3 items-center pr-3 text-gray-600 cursor-pointer">
                        <iconify-icon id="toggler2" icon="bxs:show"></iconify-icon>
                    </div>
                </div>
                <h1 class="text-[#737373] text-xs font-medium font-vietnam mb-[5px] text-start">Konfirmasi Kata Sandi
                </h1>
                <div class="relative">
                    ...
                    @enderror
                    <div class="flex absolute top-3 right-3 items-center pr-3 text-gray-600 cursor-pointer">
                        <iconify-icon id="toggler3" icon="bxs:show"></iconify-icon>
                    </div>
                </div>
                <div class="flex gap-5 justify-end mt-5">
                    <button wire:click="updatePassword" class="px-8 py-2 rounded-md button text-sm text-white">Simpan
                        perubahan</button>
                </div>
            </div>
        </div>
