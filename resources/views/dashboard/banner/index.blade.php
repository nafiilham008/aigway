<div :class="{ 'ml-56': sidebarOpen, 'ml-0': !sidebarOpen }"
    ...
    <div class=" bg-white rounded-xl py-[27px] px-20 ">
        ...
        <h1 class="text-[#737373] text-xs font-vietnam mb-8">{{ $bannerCount != 0 ? $bannerCount . ' Banner tersedia' : 'Belum ada banner tersedia' }}
        </h1>
        ...
        <livewire:dashboard.banner.component.banner-datatable>
    </div>
</div>
