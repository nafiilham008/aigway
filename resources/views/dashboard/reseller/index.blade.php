<div :class="{ 'ml-56': sidebarOpen, 'ml-0': !sidebarOpen }"
    ...
    <div class=" bg-white rounded-xl py-[27px] px-20 ">
        <h1 class="text-[#272B30] text-lg font-semibold font-vietnam mb-1">Pengaturan Reseller</h1>
        ...
        <div class="flex gap-5 justify-end">
            ...
            <button wire:click='storeOrUpdateReseller'
    ...
    <div class=" bg-white rounded-xl py-[27px] px-20 ">
        <h1 class="text-[#272B30] text-lg font-semibold font-vietnam mb-1">Reseller</h1>
        <h1 class="text-[#737373] text-xs font-vietnam mb-5">
            {{ $resellerCount != 0 ? $resellerCount . ' Reseller tersedia' : 'Belum ada reseller tersedia' }}
        </h1>
        ...
        <livewire:dashboard.reseller.component.reseller-datatable>
